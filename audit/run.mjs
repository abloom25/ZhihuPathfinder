...
run('frontend',process.execPath,['--test','--experimental-test-coverage','--test-coverage-include=src/lib/*.js','test/records.test.mjs','test/flow.test.mjs','test/shares.test.mjs'],join(root,'frontend'));
